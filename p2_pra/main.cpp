...
int main(int argc, char **argv)
{
  ...
  cout << "Empleado (Nombre y Apellido) | Salario mensual | Horas extras | Total a pagar\n";

  Empleado *mayorHoras = nullptr;
  Empleado *menorHoras = nullptr;
  int diaConMayorHoras = -1;
  float maxHorasEnDia = 0.0;
